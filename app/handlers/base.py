...
━━━━━━━━━━━━━━━━━━
✅ ОСНОВНЫЕ КОМАНДЫ
/bal — Баланс (по текущей группе)
/his — История операций (за сегодня)
/his 01.12.2025 — История за дату
/del — Удалить операцию (по паролю)
/ex — Экспорт в Excel (вся история)
/ex сегодня — Экспорт за сегодня
/rep — Отчет (текстовый)
/sum — Сумма за период (формат: /sum 01.01.2025-31.01.2025)
/help — Эта справка

━━━━━━━━━━━━━━━━━━
📊 КАССОВЫЙ ОТЧЕТ (В ЛИЧКЕ)
/cash_open — Ввод начального остатка
/cash_report — Скачать отчет (Excel)
/set_rate — Установить курс обмена (для сотрудников)
/cash_exchange — Внутренний обмен (для сотрудников)

━━━━━━━━━━━━━━━━━━
🔧 АДМИН / СОТРУДНИКИ
/allbal — Баланс по всем группам
